...
def test_demodoc() -> None:
    ...
    assert m.ipac_lead_v2.name == "Francis Carrillo"
    assert m.ipac_lead_v2.email == "francis@example.com"
    assert m.spherex_poc_v2.name == "Ursula Gomez"
    assert m.spherex_poc_v2.email == "ursula@example.com"
